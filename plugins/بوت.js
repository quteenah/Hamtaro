...
/* [❗]                      [❗]                      [❗] */
/*                                        */
/*     ◉ Otosaka (https://github.com/louk123)          */
/*     ◉ Número: wa.me/212661809542                     */
/*                                                       */
/*     —◉ FT:                                            */
/*     ◉ prince lo9mane (https://github.com/louk7777)  */
/*                                                       */
/* [❗]                      [❗]                      [❗] */
/* -------------------------------------------------------*/
...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!text) throw `*[🌹] اڪتب ماذا تريد ان تبحث عنـه في شات جي بي تي او التحدث مـ؏ـه*\n\n\n`;
  try {
