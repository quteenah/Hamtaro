...
if (!text) throw ` هذا الامر خاص بإنشـاء صـور بواسطة الذكاء الاصطناعي ويفضل الطلب باللغة الإنجليزية \n\n❕ مثال\n*${usedPrefix + command}* girl`
...
throw `*⚠️ حدثت مشكلة اخبر صاحب البوت بها*`
}}}}

}
handler.help = ['dall2']
handler.tags = ['ai']
handler.command = /^(ارسم|ارسملي|رسم|يرسم|أرسم)/i
